...
export const DashboardPage = ({ onNavigate }) => {
  ...
  return (
    <div>
      <PageHeader
        title={`Hello, ${user.name.replace('Adv. ', '')}`}
      ...
      <div>
        {showAlert && (
          <div className="mb-6 border border-emerald-200 bg-emerald-50 text-emerald-800 rounded-2xl px-5 py-4 font-medium">
          ...
          <Card className="p-0">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="pt-4 border-t border-slate-200 flex gap-2">
                <button onClick={() => onNavigate('schedule')} className="px-3 py-2 text-sm rounded-lg bg-slate-100 text-slate-800">Open Schedule</button>
                <button onClick={() => onNavigate('chat')} className="px-3 py-2 text-sm rounded-lg bg-[#071b33] text-white">Open Chat</button>
              </div>
            </div>
          </Card>
        </div>
