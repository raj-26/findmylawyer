...
import { Phone, Paperclip, Search } from 'lucide-react';
...
export const ChatPage = ({ onNavigate, navState }) => {
  ...
  useEffect(() => {
    if (!navState?.autoMessage || !navState?.clientName) return;
    ...
    setMessages((prev) => {
      const alreadyAdded = prev.some((msg) => msg.text === navState.autoMessage);
