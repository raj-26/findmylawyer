...
import { ArrowLeft, ArrowRight, Briefcase, Lock, Mail, MapPin, Phone, Scale, Shield, User } from 'lucide-react';
    ...
    <>
      <div className="min-h-screen bg-[#f1f4f9] flex flex-col">
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_0.98fr]">
          ...
          >
            <div>
              <h1 className="text-3xl font-bold text-white mb-4">Find My Lawyer</h1>
          ...
          <section className="flex items-center justify-center p-4">
            ...
            <div className="flex items-center justify-between mb-3">
              <button
                ...
                className="inline-flex items-center gap-1.5 text-sm text-slate-600 font-bold"
              >
                <ArrowLeft size={14} />
              </button>
            </div>
