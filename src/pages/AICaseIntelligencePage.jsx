    ...
    <div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        <div className="xl:col-span-4 space-y-4">
          ...
          <Card className="p-0">
            <div className="p-5">
              <p className="text-lg uppercase tracking-wide text-slate-700 font-extrabold mb-3">Quick Actions</p>
              <div className="space-y-2">
                {[
                  ...
                  <button
                    ...
                    className="w-full py-3 px-3 rounded-lg border border-slate-300 text-left text-base font-semibold text-slate-800 hover:bg-black hover:text-white hover:border-black transition-colors"
                  >
                    {action.label}
                  </button>
                ))}
